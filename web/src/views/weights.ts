// views/weights.ts — the five §3.4 recommendation weights, with the formula
// shown; PUT is full replacement. Rendered as a section of #/settings.
...
export function renderWeights(root: HTMLElement): void {
